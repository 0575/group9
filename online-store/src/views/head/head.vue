  ...
  <div id="header" class="new_header">
    <div class="hd_bar">
      <div class="bd_bar_bd cle">
        ...
        <ul id="userinfo-bar">
          <li class="more-menu" @mouseover="isShowVip=true" @mouseout="isShowVip=false"><a>Member Centre</a><i
            class="iconfont arrow"> </i>
            <div class="more-bd" :class="{show:isShowVip}">
              <div class="list">
                <router-link :to="'/app/home/member/order'">My order</router-link>
                <router-link :to="'/app/home/member/collection'">Favourite</router-link>
                <router-link :to="'/app/home/member/receive'">Address</router-link>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="hd_main cle">
      <div class="logo">
        <router-link to="/app/home/index" class="main_logo">
          <img src="../../static/images/head/logo2.png" alt="Logo" max-width="20%" max-height="100" width="auto"
      ...
      <div class="hd_nav_bd cle">
        <div class="main_nav main_nav_hover" id="main_nav">
          <div class="main_nav_link" @mouseover="overAllmenu" @mouseout="outAllmenu">
            ...
            <div class="main_cata" id="J_mainCata" v-show="showAllmenu">
              <ul>
                <li class="first" v-for="(item,index) in allMenuLabel" @mouseover="overChildrenmenu(index)"
                    @mouseout="outChildrenmenu(index)">
                        ...
                        <dl>
                          ...
                          <dd>
                            <router-link v-for="childrenList in list.sub_cat" :key="childrenList.id"
                                         :to="'/app/home/list/'+childrenList.id">{{childrenList.name}}
                            </router-link>
                          </dd>
                        </dl>
                        <div class="clear"></div>
        ...
        <div class="hd_cart" id="ECS_CARTINFO" @mouseover="overShopCar" @mouseout="outShopCar">
          <router-link class="tit" :to="'/app/shoppingcart/cart'" target=_blank>
            ...
            <b class="iconfont">&#xe600;</b>Shopping Cart<span><i class="iconfont">&#xe645;</i></span>
...
<script>
    ...
    import {deleteShopCart, getCategory, getHotSearch} from '../../api/api'

    export default {
        data() {
            return {
                hotSearch: [],//hot search words
                searchWord: '',//search words
                showAllmenu: false,//menu control
                allMenuLabel: [],//menu
                showChildrenMenu: -1,//children menu control
                showShopCar: false,//shopping cart control
                isShowVip: false,
            }
        },
        computed: {
        ...
        methods: {
            ...
            deleteGoods(index, id) { //Delete goods
