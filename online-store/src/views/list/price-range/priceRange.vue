      ...
      <dl>
        ...
        <dd class="dd-price" style="height: 48px;">
          <div class="items cle w500">
            <div class="link" v-for="item in priceRange" @click="changePriceRange(item.min,item.max)"><a class="item">{{item.min}}&nbsp;-&nbsp;{{item.max}}</a>
            </div>
          </div>
          <div class="priceform" id="priceform" v-clickoutside="handleClickOutside">
            <div class="form-bg">
              <form id="freepriceform">
                <span>$</span>
                <input type="text" value="" name="price_min" id="pricemin" placeholder="min" v-model="price_min" @focus="focus=true">
                <span>-$</span>
                <input type="text" value="" name="price_max" id="pricemax" placeholder="max" v-model="price_max" @focus="focus=true">
                <input v-show="focus" value="Apply" @click="changePriceRange(price_min, price_max)" class="submit">
              </form>
            </div>
          </div>
        </dd>
