      ...
      <li v-for="item in listData">
        <router-link :to="'/app/home/productDetail/'+item.id" target="_blank" class="productitem">
                    <span class="productimg">
                        <img width="150" height="150" :title="item.productname" :alt="item.productname"
                             :src="item.goods_front_image" style="display: block;">
                    </span>
          ...
          <span class="salerow">Sales：<span class="sales">{{item.sold_num}}</span> Sold </span>
        </router-link>
      </li>
    </ul>
    <br clear="all">
