          ...
          <div class="pic_view">
            <a class="MagicZoomPlus" id="Zoomer"
              ...
              <div class="MagicZoomPup"
                   style="z-index: 10; position: absolute; overflow: hidden;  visibility: hidden; width: 190px; height: 190px; opacity: 0.5;"></div>
              <div class="MagicZoomPlusHint"
                   style="display: block; overflow: hidden; position: absolute; visibility: visible; z-index: 1; left: 2px; right: auto; top: 2px; bottom: auto; opacity: 0.75; max-width: 376px;"></div>
            </a>
          </div>
            ...
            <div class="bd">
              <div class="tempWrap" style="overflow:hidden; position:relative; width:330px">
                <ul class="cle"
                  ...
                  <li v-for="(item,index) in proDetail.images" :class="{'current': index===curIndex}"
          ...
          <dl class="loaded">
            ...
            <dd class="property">
              <ul>
                ...
                <li>
                  <span class="icon_promo">On Sale</span> <span class="lbl">Sale price</span><span class="unit"> <strong
                  class="nala_price red" id="ECS_SHOPPRICE">${{proDetail.shop_price}}</strong> </span> <span
            ...
            <dd class="tobuy-box cle">
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum" id="skunum"><span class="minus" title="Reduce 1 quantity" @click="reduceNum"><i
                    class="iconfont">-</i></span>
                    <input id="number" name="number" type="text" min="1" v-model="buyNum" onchange="countNum(0)">
                    <span class="add" title="Increase 1 quantity" @click="addNum"><i class="iconfont">+</i></span> <cite
                      class="storage"> Items </cite>
                  </div>
                  <div class="skunum" id="skunum">

                    <cite class="storage">(<font id="shows_number">{{proDetail.goods_num}} Items</font>)</cite>
                ...
                <li class="add_cart_li">
                  ...
                  <a v-if="hasFav" id="fav-btn" class="graybtn" @click="deleteCollect">
                    <i class="iconfont">&#xe613;</i>Favorited</a>
                  <a v-else class="graybtn" @click="addCollect">
                    <i class="iconfont">&#xe613;</i>Add to Favorite</a>
                </li>
              </ul>
            </dd>
          </dl>
...
<script>
    ...
    import {addFav, addShopCart, delFav, getFav, getGoodsDetail} from '../../api/api';
