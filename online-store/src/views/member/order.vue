          ...
          <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              ...
              <tr v-for="item in orders">
                ...
                <td v-if="item.pay_status == 'paying' " align="center" bgcolor="#ffffff">To be paid</td>
                <td v-if="item.pay_status == 'TRADE_SUCCESS' " align="center" bgcolor="#ffffff">Paid</td>
                <td align="center" bgcolor="#ffffff"><font class="f6"><a @click="cancelOrder(item.id)">Cancel Order</a></font>
                </td>
              </tr>
              </tbody>
            </table>
...
<script>
    import {delOrder, getOrders} from '../../api/api'
