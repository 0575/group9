<template>
  ...
  <div class="slidebar">
    <h3 class="my_nala">
      <a @click="member">Member Center</a>
    </h3>
    <ul class="slide_item">
      <li class="item">
        <div class="root_node"><i class="iconfont">&#xe645;</i>Order Center</div>
        <ul>
          <li>
      ...
      <li class="item">
        <div class="root_node"><i class="iconfont">&#xe645;</i>Member Center</div>
        <ul>
          <li>
            <a :class="{on: current==='userinfo'}" @click="toUserInfo">User Information</a>
            <a :class="{on: current==='collection'}" @click="toCollection">My Favourites</a>
            <a :class="{on: current==='message'}" @click="toMessage">My Comments</a>
          </li>
        </ul>
      </li>
    </ul>
