          ...
          <div class="userCenterBox boxCenterList clearfix" style="_height:1%; font-size:14px;">
            ...
            <div class="message-all">
              <ul>
                <li v-for="(item,index) in messageAll">
                  <div>
                    <span v-if="item.message_type===1">Message:</span>
                    <span v-if="item.message_type===2">Complaint:</span>
                    <span v-if="item.message_type===3">Inquiry:</span>
                    <span v-if="item.message_type===4">After sale:</span>
                    <span v-if="item.message_type===5">Wanted:</span>
            ...
            <form action="" method="post" enctype="multipart/form-data" name="formMsg">
              <table width="100%" border="0" cellpadding="3">
                <tbody>
                <tr>
                  <td align="right">Message types:</td>
                  <td>
                ...
                <tr>
                  <td align="right" valign="top">Message contents：</td>
                  <td><textarea name="msg_content" cols="50" rows="4" wrap="virtual" class="B_blue"
                                v-model="message"></textarea></td>
                </tr>
                <tr>
...
<script>
    import {addMessage, delMessages, getMessages} from '../../api/api'
