      ...
      <div class="box">
        <div class="box_1">
          <div class="userCenterBox boxCenterList clearfix" style="_height:1%; font-size:14px;">
            ...
            <h5><span>My Favourite</span></h5>
            <div class="blank"></div>
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tbody>
              <tr align="center">
                <th width="35%" bgcolor="#ffffff">Item name</th>
                <th width="30%" bgcolor="#ffffff">Price</th>
                <th width="35%" bgcolor="#ffffff">Operate</th>
              </tr>
              <tr v-for="(item,index) in collections">
                <td bgcolor="#ffffff">
                  <router-link :to="'/app/home/productDetail/'+item.goods.id" class="f6" target="_blank">
                    {{item.goods.name}}
                  </router-link>
                </td>
...
<script>
    import {delFav, getAllFavs} from '../../api/api'
