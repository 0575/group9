            ...
            <div class="tab-form">
                <form id="mobile_register_form" autocomplete="off">
                    ...
                    <div class="form-group marb8">
                        ...
                        <input id="jsRegMobile" name="account" v-model="name" type="text" placeholder="enter username">
                    </div>
                    <p class="error-text marb8" v-show="error.username">{{error.username}}</p>

                    <div class="form-group marb8">
                        <label>Password</label>
                        <input id="jsPhoneRegPwd" name="password_m" type="password" v-model="password" placeholder="enter password">
                    </div>
                    ...
                    <input class="btn btn-green" id="jsMobileRegBtn" @click="isRegister" type="button" value="Register">
                </form>
            </div>
