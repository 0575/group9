  ...
  <div class="menu">
    ...
    <div>
      <ul v-for="(item, index) in data">
        ...
        <li class="menu-item menu-folder" :id="item.folderId" @click="openMenu(item, index,item.folderId)"
            @contextmenu.prevent="show(item)">
        ...
        <li class="menu-item menu-item-children" v-if="item.children" v-for="(childItem,childIndex) in item.children"
            v-show="dataArr[index]"
            :id="childItem.folderId" :class="{'menu-active':activeChildIndex === childIndex && activeIndex === index}"
            @click="menuActive(index, childIndex,childItem.folderId)"
            @contextmenu.prevent="subShow(childItem ,item.folderName)">
