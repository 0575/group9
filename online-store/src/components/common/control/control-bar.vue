  ...
  <div class="control-bar">
    ...
    <div v-if="!isSelect" class="slot sort-type">
      ...
      <span class="sort-item" v-for="(item,index) in sortArr">
                <label>{{item}}</label>
                <span class="sort"><i class="iconfont icon-arrow-up"
                                      :class="{'icon-clicked':iconIndex === index && iconType === 'up'}"
                                      @click="sort(index, 'up')">&#xe664;</i><i class="iconfont icon-arrow-down"
                                                                                :class="{'icon-clicked':iconIndex === index && iconType === 'down'}"
                                                                                @click="sort(index, 'down')">&#xe63b;</i></span>
            </span>
    </div>
