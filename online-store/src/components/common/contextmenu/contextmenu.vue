<template>
  <div id="contextMenu-box" class="contextMenu-box" @mouseover="isShowChildIndex = null" @click="removeDom"
       @contextmenu.prevent="removeDom">
    <ul id="contextMenu" class="contextMenuPlugin" :style="{left:left,top:top}">
      <li v-for="(m,index) in items.items" :key="index" @click.stop="rightClick(m.action)"
          @mouseover.stop="isShowChildIndex = index">
        <div class="ellipsis">
